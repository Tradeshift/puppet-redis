...
gem 'json', '< 2.8.3',                    :require => false if Gem::Version.new(RUBY_VERSION) < Gem::Version.new('2.0.0')
gem 'json_pure', '<= 2.7.2',              :require => false if Gem::Version.new(RUBY_VERSION) < Gem::Version.new('2.0.0')
